...
398 -2 397 -280 0 -280 0 0 -1085z" />
            ...
            <Content>
                <ErrorMessage>Você não está logado ou sua sessão expirou.</ErrorMessage>
                <SubMessage>Por favor, faça login novamente para acessar o sistema.</SubMessage>
                <LoginButton onClick={handleLoginRedirect}>Ir para Login</LoginButton>
            </Content>
        </Container>
    );
}
